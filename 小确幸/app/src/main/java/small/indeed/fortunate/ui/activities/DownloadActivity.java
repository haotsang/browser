...
import small.indeed.fortunate.download.*;
import small.indeed.fortunate.download.DownloadUtil.*;

	public class DownloadActivity extends AppCompatActivity implements OnClickListener {
		...
		BaseAdapter myAdapter = new BaseAdapter() {
			...
			public View getView(int position, View convertView, ViewGroup parent) {
				...
				Holder holder = null;
				if (convertView == null) {
					convertView = LayoutInflater.from(DownloadActivity.this).inflate(
			...
			private void setClick(Holder holder) {
				holder.button_start.setOnClickListener(DownloadActivity.this);
				holder.button_pause.setOnClickListener(DownloadActivity.this);
				holder.button_resume.setOnClickListener(DownloadActivity.this);
				holder.button_delete.setOnClickListener(DownloadActivity.this);
			}
